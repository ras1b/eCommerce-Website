...
function createPage($pmethod, $paction, array $pform)
{
    ...
    nullAsEmpty($pform, "inputUsername");
    ...
    <p> <u>Sign up to weekly news</u> </p>
    </div>
                ...
                <div class="form-group">
    		        ...
    		        <div class="col-xs-9">
    		            <input type="username" class="form-control" id="inputUsername" 
                         name="inputUsername" placeholder="Username" value="{$pform["inputUsername"]}">
    		        </div>
    		    </div>
    		    <div class="form-group">
...
function saveUser($username, $email, $password, $firstName, $lastName, $phoneNumber)
{
    ...
    $tresponse = <<<RESPONSE
    		<section class="panel panel-primary" id="Form Response">
    				<div class="response">
                        ...
                        Thank you creating an account with us!</p>
                        <p> Your account username is {$pformdata["inputUsername"]}</p>
...
function processForm(array $pformdata): array
{
    ...
    if ($tvalid && empty($pformdata["inputUsername"])) {
        $tvalid = false;
    }
    ...
    if ($tvalid) {
        saveUser($pformdata['inputUsername'], $pformdata['inputEmail'], $pformdata['inputPassword'], $pformdata['firstName'], $pformdata['lastName'], $pformdata['phoneNumber']);
        $pformdata['valid'] = true;
    }
    return $pformdata;
}
